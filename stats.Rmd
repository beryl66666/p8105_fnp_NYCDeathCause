...
```
As we can see from the graph, the number of suspects who were complained about were much larger than the number of females and unknown gender. A large number of the complained suspects are in the 25-44 age group, so we should be careful of 25-44 year old males in case of danger.
...
complaint_df %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5))
```
Analysis of the graphs shows that the frequency of crime locations is home is the highest in 2020 and 2021, followed by street and public housing.