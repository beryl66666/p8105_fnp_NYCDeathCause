...
As results, the p-value of chi-square test was much smaller than alpha = 0.05, we **reject H0**. We draw the conclusion that sex of victim and sex of suspect are *not independent* at 0.05 significance level, which might indicate that young male suspects and yong female victims had the higher likelihood to be correlated with each other.
